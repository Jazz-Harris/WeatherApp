...
const Weather = ({ data }) => {
  ...
  return (
    ...
    <div>
      ...
      <div className="relative flex justify-between pb-12 ">
        ...
        <div className="flex flex-col items-center">
          <Image
            ...
            height="100"
          />
          <p className="text-2xl text-gray-100">{data.weather[0].description}</p>
        </div>
      ...
      <div className="flex col-span-2 justify-between text-center ">
      ...
      <div className="flex col-span-2 justify-between text-center mb-10">
        <div className="bg-black/50 relative p-2  rounded-md   mt-2 pt-2 ">
